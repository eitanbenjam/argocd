...
| cs-probe.probe-core-ms-chart.configMap.clusterName | string | `"CLBA"` |  |
...
| cs-probe.probe-core-ms-chart.configMap.machineType | string | `"cLBA"` |  |
| cs-probe.probe-core-ms-chart.configMap.name | string | `"cLBA"` |  |
...
| cs-probe.probe-core-ms-chart.deployments.probecoremsDeployment.annotations."k8s.v1.cni.cncf.io/networks" | string | `"dpdk-net-mirror-probe-100003,dpdk-net-internal-probe-100003"` |  |
...
| cs-probe.probe-core-ms-chart.deployments.probecoremsDeployment.containers.probecoremsContainer.env.AWS_RADCOM_PACKET_INTERNAL_INTF_NAMES | string | `"net2"` |  |
| cs-probe.probe-core-ms-chart.deployments.probecoremsDeployment.containers.probecoremsContainer.env.AWS_RADCOM_PACKET_MIRROR_INTF_NAMES | string | `"net1"` |  |
...
| global.configMap.probeId | string | `"100003"` |  |
